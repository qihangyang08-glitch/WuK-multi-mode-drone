...
public:
    ...
    // WuK Morph support
    void set_morph_angle(float angle_deg) override;
    void set_ground_thrust(float fwd_thrust, float diff_thrust);
    void set_morph_comp_enabled(bool enabled) override { _morph_comp_enabled = enabled; }
...
protected:
    // WuK Morph state
    float _morph_angle_deg;
    float _ground_fwd_thrust;
    float _ground_diff_thrust;
    bool  _morph_comp_enabled;
