...
public:
    ...
    float last_roll_value = 1500;
    float last_pitch_value = 1500;
    ...
    // allow external override of roll/pitch servo PWM (set -1 to disable)
    void set_external_roll_pwm(int16_t pwm) { external_roll_pwm = pwm; }
    void set_external_pitch_pwm(int16_t pwm) { external_pitch_pwm = pwm; }
    void clear_external_roll_pwm(void) { external_roll_pwm = -1; }
    void clear_external_pitch_pwm(void) { external_pitch_pwm = -1; }
...
private:
    ...
    Vector3f position;
    // external override PWMs (-1 = disabled)
    int16_t external_roll_pwm = -1;
    int16_t external_pitch_pwm = -1;
