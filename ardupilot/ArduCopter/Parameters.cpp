...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Group: WUK_
    // @Path: WuK_Comms.cpp
    GOBJECT(wuk_comms, "WUK_", WuK_Comms),
...
const AP_Param::GroupInfo ParametersG2::var_info2[] = {
    ...
    // @Param: WUK_MORPH_RATE
    // @DisplayName: WuK Morph Rate
    // @Description: Rate of morph transition in degrees per second.
    // @Units: deg/s
    // @Range: 1 90
    // @User: Standard
    AP_GROUPINFO("WUK_MORPH_RATE", 14, ParametersG2, wuk_morph_rate, 9.0f),  // [WuK] 变构速率(度/秒)

    // @Param: WUK_MORPH_DWELL
    // @DisplayName: WuK Morph Dwell
    // @Description: Dwell time at 45 degrees before switching to ground mode.
    // @Units: s
    // @Range: 0 10
    // @User: Standard
    AP_GROUPINFO("WUK_MORPH_DWELL", 15, ParametersG2, wuk_morph_dwell, 2.0f),  // [WuK] 45°悬停时间(秒)

    // @Param: WUK_COMP_EN
    // @DisplayName: WuK Compensation Enable
    // @Description: Enable mixer compensation for morph angle (0-45 deg).
    // @Values: 0:Disabled, 1:Enabled
    // @User: Standard
    AP_GROUPINFO("WUK_COMP_EN", 16, ParametersG2, wuk_comp_enable, 1),
