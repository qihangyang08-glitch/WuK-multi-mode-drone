...
// @LoggerMessage: WUK
// @Description: WuK Morph Project Data
// @Field: TimeUS: Time since system startup
// @Field: Angle: Current morph angle
// @Field: State: Arduino state
// @Field: Error: Arduino error flags
// @Field: Cmd: Last command sent
    { LOG_WUK_MSG, sizeof(log_WuK),
      "WUK", "QHBBH", "TimeUS,Angle,State,Error,Cmd", "s----", "F----", true },
